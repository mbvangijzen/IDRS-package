%
% This programme illustrates the use of the idrs-routines on an academic integer dense system.
...
disp('Integer random test problem');
disp('+++++++++++++++++++++++++++');
...
disp('Integer random problem, N=100 gridpoints.');
...
ylabel('|r|/|b|')
title(['IDR integer random matrix']);
grid on;
