%
% This programme illustrates the use of the idrs-rotines module on an academic complex dense system.
...
disp('Complex random test problem');
disp('+++++++++++++++++++++++++++');
...
disp('Complex random problem, N=100 gridpoints.');
...
ylabel('|r|/|b|')
title(['IDR complex random matrix']);
grid on;
